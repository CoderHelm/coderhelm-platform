...
const PAYMENT_FAILED_HTML = EMAIL_WRAPPER(`
  ...
  <a href="https://app.coderhelm.com/billing" style="display:inline-block;background:#fff;color:#000;padding:10px 20px;border-radius:6px;text-decoration:none;font-weight:600;margin-top:8px">Update Payment Method</a>
`);
...
https://app.coderhelm.com/billing`;
